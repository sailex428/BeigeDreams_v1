...
void main() {
    ...
    if(Color.xyz==vec3(255., 85., 85.)/ 255.) {
        ...
        if(Position.z == 0. && gl_VertexID <= 6 && gl_Position.x > 0.95) vertexColor=vec4(0);
    ...
    vertexDistance=length((ModelViewMat*vertex).xyz);texCoord0=UV0;
}